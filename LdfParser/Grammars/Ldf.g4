...
node_master: 'Master' ':' ldf_name COMMA ldf_float 'ms' COMMA ldf_float 'ms' (COMMA ldf_int 'bits' COMMA ldf_float '%')? SEMI;
node_slaves: 'Slaves' ':' ldf_name (COMMA ldf_name)* SEMI;

// Signals
signals: 'Signals' '{' signal_definition* '}';
signal_definition: ldf_name ':' ldf_int COMMA ldf_int COMMA ldf_name (COMMA ldf_name)* SEMI;

// Diagnostic_signals
diagnostic_signals: 'Diagnostic_signals' '{' diagnostic_signal_definition* '}';
diagnostic_signal_definition: ldf_name ':' ldf_int COMMA ldf_int SEMI;

// Frames
frames: 'Frames' '{' frame_definition* '}';
frame_definition: ldf_name ':' ldf_int COMMA ldf_name COMMA ldf_int '{' frame_signal* '}';
...
signal_encoding_logical_value: 'logical_value' COMMA ldf_int COMMA ldf_str SEMI;
signal_encoding_physical_value: 'physical_value' COMMA ldf_int COMMA ldf_int COMMA ldf_float COMMA ldf_float COMMA ldf_str SEMI;

// Signal_representation
signal_representation: 'Signal_representation' '{' signal_representation_definition* '}';
signal_representation_definition: ldf_name ':' ldf_name (COMMA ldf_name)* SEMI;
